...
const ConfirmUI: FC<IConfirmUIProps> = ({
  ...
  return (
    <div className="w-[420px] max-w-full rounded-lg p-7 bg-white dark:bg-neutral-900">
      ...
      <div className='mt-1 ml-12'>
        <div className='text-sm leading-normal text-neutral-400'>{content}</div>
      </div>
      ...
      <div className='flex gap-3 mt-4 ml-12'>
        ...
        <div onClick={onCancel} className='w-20 leading-9 text-center text-neutral-400 border rounded-lg cursor-pointer h-9 border-color-gray-200'>{cancelText || t('common.operation.cancel')}</div>
      </div>
    </div>
