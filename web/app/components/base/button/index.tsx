...
const Button: FC<IButtonProps> = ({
  ...
  switch (type) {
    ...
    case 'warning':
      ...
      break
    default:
      style = disabled ? 'border-solid border border-gray-200 bg-gray-200 cursor-not-allowed text-neutral-200' : 'border-solid border border-gray-200 cursor-pointer text-neutral-400 hover:bg-white hover:shadow-sm hover:border-gray-300'
      break
  }
