  ...
  return (
    <div
      ...
      className={`
        ...
        ${option.disabled ? 'cursor-not-allowed opacity-30' : 'hover:bg-gray-50 dark:hover:bg-gray-900 cursor-pointer'}
      `}
      tabIndex={-1}
      ...
      menuRenderFn={(
        ...
        (anchorElementRef.current && options.length)
          ? ReactDOM.createPortal(
            <div className='mt-[25px] p-1 w-[400px] bg-white dark:bg-neutral-900 rounded-lg border-[0.5px] border-gray-200 shadow-lg'>
