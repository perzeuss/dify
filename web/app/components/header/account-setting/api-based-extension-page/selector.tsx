      ...
      <PortalToFollowElemTrigger onClick={() => setOpen(v => !v)} className='w-full'>
        {
          currentItem
            ? (
              <div className='flex items-center justify-between pl-3 pr-2.5 h-9 bg-gray-100 dark:bg-neutral-950 rounded-lg cursor-pointer'>
            ...
            : (
              <div className='flex items-center justify-between pl-3 pr-2.5 h-9 bg-gray-100 dark:bg-neutral-950 rounded-lg text-sm text-gray-400 cursor-pointer'>
