...
const Card: FC<CardProps> = ({
  ...
  return (
    <div className='px-3 pb-3'>
      {
        models.map(model => (
          <div key={`${model.model_name}-${model.model_type}`} className='flex mb-1 px-3 py-2 bg-white dark:bg-neutral-900 rounded-lg shadow-xs last:mb-0'>
            <div className='grow'>
              <div className='flex items-center mb-0.5 h-[18px] text-[13px] font-medium text-gray-700 dark:text-gray-300'>
                {model.model_name}
            ...
            <div className='flex items-center'>
              ...
              <Selector
                ...
                className={open => `${open && '!bg-gray-100 dark:bg-neutral-950 shadow-none'} flex justify-center items-center w-7 h-7 bg-white dark:bg-neutral-900 rounded-md border-[0.5px] border-gray-200 shadow-xs cursor-pointer hover:bg-gray-100`}
