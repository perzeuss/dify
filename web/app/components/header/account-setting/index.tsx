    ...
    >
      <div className='flex'>
        ...
        <div ref={scrollRef} className='relative w-[824px] h-[720px] pb-4 overflow-y-auto'>
          <div className={cn('sticky top-0 px-6 py-4 flex items-center justify-between h-14 mb-4 bg-white dark:bg-black text-base font-medium text-gray-900 z-20', scrolled && scrolledClassName)}>
