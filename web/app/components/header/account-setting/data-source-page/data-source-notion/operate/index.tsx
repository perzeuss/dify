...
export default function Operate({
  ...
  const itemClassName = `
    flex px-3 py-2 hover:bg-gray-50 dark:hover:bg-gray-900  dark:hover:bg-gray-900 text-sm text-gray-700 dark:text-gray-300
    cursor-pointer
  `
    ...
    <Menu as="div" className="relative inline-block text-left">
      {
        ({ open }) => (
          <>
            <Menu.Button className={`flex items-center justify-center w-8 h-8 rounded-lg hover:bg-gray-100 dark:bg-neutral-950 ${open && 'bg-gray-100'}`}>
