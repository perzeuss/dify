  ...
  return (
    ...
    >
      <PortalToFollowElemTrigger onClick={() => setOpen(v => !v)}>
        <div className='flex items-center px-2 max-w-[240px] h-7 bg-white dark:bg-neutral-900 rounded-lg'>
      ...
      <PortalToFollowElemContent style={{ zIndex: 1000 }}>
        <div className='w-[360px] bg-gray-50 rounded-xl shadow-lg'>
          ...
          <div className='px-4 py-0.5 max-h-[450px] bg-white dark:bg-neutral-900 rounded-lg overflow-auto'>
            {
