...
const HistoryPanel: FC<Props> = ({
  ...
  return (
    <Panel
      ...
      headerIcon={
        <div className='p-1 rounded-md bg-white dark:bg-neutral-900 shadow-xs'>
    ...
    >
      {showWarning && (
        <div className='flex justify-between py-2 px-3 rounded-b-xl bg-[#FFFAEB] text-xs text-gray-700 dark:text-gray-300'>
