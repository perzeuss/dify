...
const SettingsModal: FC<SettingsModalProps> = ({
  ...
  return (
    <div
      className='overflow-hidden w-full flex flex-col bg-white dark:bg-neutral-900 border-[0.5px] border-gray-200 rounded-xl shadow-xl'
      style={{
    ...
    >
      ...
      <div className='p-6 pt-5 border-b overflow-y-auto pb-[68px]' style={{
        ...
        <div className={cn(rowClass)}>
          ...
          <div className='grow'>
            ...
            />
            <a className='mt-2 flex items-center h-[18px] px-3 text-xs text-neutral-400' href="https://docs.dify.ai/advanced/datasets#how-to-write-a-good-dataset-description" target='_blank'>
        ...
        {indexMethod === 'high_quality' && (
          <div className={cn(rowClass)}>
            ...
            <div className='grow'>
              ...
              <div className='mt-2 w-full text-xs leading-6 text-neutral-400'>
      ...
      <div
        className='sticky z-[5] bottom-0 w-full flex justify-end py-4 px-6 border-t bg-white dark:bg-neutral-900 '
        style={{
