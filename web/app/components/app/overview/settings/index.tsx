    ...
    <>
      ...
      >
        ...
        <div className='flex mt-2'>
          ...
          />
          <input className={`flex-grow rounded-lg h-10 box-border px-3 ${s.projectName} bg-gray-100 dark:bg-neutral-950`}
        ...
        {isShowMore && <>
          ...
          <input className={`w-full mt-2 rounded-lg h-10 box-border px-3 ${s.projectName} bg-gray-100 dark:bg-neutral-950`}
