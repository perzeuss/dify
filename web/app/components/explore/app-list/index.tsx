  ...
  return (
    <div className='h-full flex flex-col border-l border-gray-200'>
      <div className='shrink-0 pt-6 px-12'>
        ...
        <div className='text-neutral-400 text-sm'>{t('explore.apps.description')}</div>
      </div>
      <Category
      ...
      />
      <div className='relative flex flex-1 mt-6 pb-6 flex-col overflow-auto bg-gray-100 dark:bg-neutral-950 shrink-0 grow'>
        <nav
