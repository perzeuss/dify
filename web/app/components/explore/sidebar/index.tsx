  ...
  return (
    <div className='w-fit sm:w-[216px] shrink-0 pt-6 px-4 border-gray-200 cursor-pointer'>
      <div>
        <Link
          href='/explore/apps'
          className={cn(isDiscoverySelected ? 'text-primary-600  bg-white dark:bg-neutral-900 font-semibold' : 'text-gray-700 dark:text-gray-300 font-medium hover:bg-neutral-800', 'flex items-center pc:justify-start pc:w-full mobile:justify-center mobile:w-fit h-9 px-3 mobile:px-2 gap-2 rounded-lg')}
        ...
        <Link
          href='/explore/chat'
          className={cn(isChatSelected ? 'text-primary-600  bg-white dark:bg-neutral-900 font-semibold' : 'text-gray-700 dark:text-gray-300 font-medium hover:bg-neutral-800', 'flex items-center pc:justify-start pc:w-full mobile:justify-center mobile:w-fit h-9 px-3 mobile:px-2 gap-2 rounded-lg')}
