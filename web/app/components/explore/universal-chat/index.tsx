        ...
        <div className={cn(
          ...
          {(!isNewConversation || isResponsing || errorHappened) && (
            <div className='mb-5 antialiased font-sans shrink-0 relative mobile:min-h-[48px] tablet:min-h-[64px]'>
              <div className='absolute z-10 top-0 left-0 right-0 flex items-center justify-between border-b border-neutral-800 mobile:h-12 tablet:h-16 px-8 bg-white dark:bg-neutral-900'>
