    ...
    <div className={'flex flex-col relative'}>
      <div className='absolute right-0 top-0 flex items-center h-7'>
        {isEditing && (
          <>
            <Button
              className='mr-2 !h-7 !px-3 !py-[5px] text-xs font-medium text-gray-700 dark:text-gray-300 !rounded-md'
        ...
        {!isEditing && !archived && embeddingAvailable && (
          <>
            <div className='group relative flex justify-center items-center w-6 h-6 hover:bg-gray-100 dark:bg-gray-900 rounded-md cursor-pointer'>
              <div className={cn(s.editTip, 'hidden items-center absolute -top-10 px-3 h-[34px] bg-white dark:bg-black rounded-lg whitespace-nowrap text-xs font-semibold text-gray-700 dark:text-gray-300 group-hover:flex')}>{t('common.operation.edit')}</div>
