    ...
    <>
      <div className={s.wrapper}>
        <div className='pt-2 rounded-tl-xl rounded-tr-xl bg-[#EEF4FF]'>
          <div className="px-4 pb-2 flex justify-between h-8 items-center">
            ...
            >
              <div
                ...
                className='flex px-2 h-7 items-center space-x-1 bg-white dark:bg-neutral-900 hover:bg-[#ECE9FE] rounded-md shadow-sm cursor-pointer text-[#6927DA]'
              >
          ...
          <div className='h-2 rounded-tl-xl rounded-tr-xl bg-white dark:bg-neutral-900'></div>
        </div>
