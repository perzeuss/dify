...
const itemClass = `
  w-full sm:w-[234px] p-3 rounded-xl bg-gray-25 border border-neutral-800 cursor-pointer
`
const radioClass = `
    ...
    <div className={classNames(s.wrapper, 'flex justify-between w-full flex-wrap gap-y-2')}>
      {
        options.map(option => (
          ...
          >
            ...
            <div className='pl-9 text-xs text-neutral-400 leading-[18px]'>{option.desc}</div>
          </div>
        ))
      }
    </div>
