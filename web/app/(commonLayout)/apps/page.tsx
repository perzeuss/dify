...
const AppList = async () => {
  ...
  return (
    <div className='flex flex-col overflow-auto bg-gray-100 dark:bg-neutral-950 shrink-0 grow'>
      <Apps />
      <footer className='px-12 py-6 grow-0 shrink-0'>
        <h3 className='text-xl font-semibold leading-tight text-gradient'>{t('join')}</h3>
        <p className='mt-1 text-sm font-normal leading-tight text-gray-700 dark:text-gray-300'>{t('communityIntro')}</p>
