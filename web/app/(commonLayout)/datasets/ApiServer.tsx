...
const ApiServer: FC<ApiServerProps> = ({
  ...
  return (
    <div className='flex items-center flex-wrap gap-y-2'>
      <div className='flex items-center mr-2 pl-1.5 pr-1 h-8 bg-white dark:bg-black/80 border-[0.5px] border-white rounded-lg leading-5'>
      ...
      <SecretKeyButton
        className='flex-shrink-0 !h-8 bg-white dark:bg-black'
